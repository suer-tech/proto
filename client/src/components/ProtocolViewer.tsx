        ...
        sections: [
          {
            ...
            makeParagraph("Протокол подготовлен: Суяргулов И.Н.", { alignment: AlignmentType.LEFT, spacing: { after: 100 } }),
            makeParagraph("Контактный e-mail: suyargulov@teamidea.ru", { alignment: AlignmentType.LEFT, spacing: { after: 100 } }),
                  ...
                  return (
                    <div className="max-w-full" style={{ fontFamily: 'Times New Roman, serif', fontSize: '12pt' }}>
                      ...
                      <div style={{ marginTop: '40px' }}>
                        <p style={{ marginBottom: '10px' }}>Протокол подготовлен: Суяргулов И.Н.</p>
                        <p style={{ marginBottom: '10px' }}>Контактный e-mail: suyargulov@teamidea.ru</p>
                        <p>Дата: {data.date}</p>
                      </div>
                    </div>
                  );
